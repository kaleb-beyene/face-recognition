    ...
    <section className="m-8 flex gap-4">
      <div className="w-full lg:w-3/5 mt-24">
        ...
        <form className="mt-8 mb-2 mx-auto w-80 max-w-screen-lg lg:w-1/2">
          {errorMsg && <Typography variant="small" color="blue-gray" className="-mb-3 font-medium text-red-600 pb-6">
            {errorMsg}
          </Typography>}
          ...
          <Button className="mt-6" fullWidth onClick={handleSubmit} disabled={loginUserLoading}>
